...
from rna2vec.histogram import Histogram
from rna2vec.generators import SeqGenerator, KmerSeqIterable, SeqMapper, SeqFragmenter
from rna2vec.generators import DisjointKmerFragmenter, SlidingKmerFragmenter
...
def main():
    ...
    argp.add_argument('--out-dir', help="output directory", default='../dataset/rna2vec/results')
