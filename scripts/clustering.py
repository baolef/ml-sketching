...
def load(path, idx: int = 0, n=50):
    ...
    return np.array(X)[:50000], np.array(Y)[:50000]
...
def main(args):
    ...
    with open(args.output, 'a') as f:
        f.write(f'input: {args.input}, distance: {args.distance}, level: {args.column}, n_classes: {n_classes}, ari: {score}\n')
